...
export interface DataContextType {
    ...
    loading: boolean;
    addStudent: (studentData: Omit<Student, 'id' | 'school_id' | 'status' | 'enrollment_date' | 'avatar_url' | 'grades' | 'attendance' | 'occurrences' | 'documents' | 'individualAgenda' | 'communicationLog' | 'tuition_plan_id' | 'medical_notes'>) => void;
