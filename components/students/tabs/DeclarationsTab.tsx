...
const DeclarationsTab: React.FC<DeclarationsTabProps> = ({ student }) => {
        ...
        <div className="space-y-4">
            ...
            <div className="flex items-end space-x-4">
                <div className="flex-grow">
                    <label htmlFor="declaration-type-tab" className="block text-sm font-medium text-gray-700">Tipo de Declaração</label>
                    <select
                        id="declaration-type-tab"
                ...
                <button
                    ...
                    className="flex-shrink-0 flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-brand-primary hover:bg-sky-600"
                >
                    Gerar
                </button>
            </div>
             ...
             {generatedText && (
                 <div className="pt-4 border-t">
                    ...
                    <textarea
                        ...
                        rows={10}
                        className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 bg-slate-50 font-serif text-brand-text-dark"
                    />
                </div>
            )}
        </div>
