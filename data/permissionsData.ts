...
export const allPermissions: { name: Permission, label: string, module: string }[] = [
  ...
  { name: 'delete_students', label: 'Excluir Alunos', module: 'Alunos' },
  // Staff
  ...
  { name: 'delete_staff', label: 'Excluir Funcionários', module: 'Funcionários' },
  // Financials
  ...
  { name: 'delete_leads', label: 'Excluir Leads', module: 'Admissões' },
  ...
  { name: 'edit_agenda_items', label: 'Editar Itens da Agenda', module: 'Agenda' },
  { name: 'delete_agenda_items', label: 'Excluir Itens da Agenda', module: 'Agenda' },
  // Communications
  ...
  { name: 'edit_communications', label: 'Editar Comunicações', module: 'Comunicação' },
  { name: 'delete_communications', label: 'Excluir Comunicações', module: 'Comunicação' },
  // Declarations
