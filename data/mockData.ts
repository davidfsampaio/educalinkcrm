...
export const mockStudents: Student[] = [
    { id: 1, name: 'Lucas Silva', class: 'Turma A', enrollmentDate: '2023-02-01', status: StudentStatus.Active, parentName: 'Ana Silva', parentContact: '(11) 91234-5678', avatarUrl: 'https://picsum.photos/seed/student1/100/100', cpf: '123.456.789-10', address: 'Rua das Flores, 123', email: 'ana.silva@email.com', phone: '(11) 91234-5678', tuition_plan_id: 1, medicalNotes: 'Alergia a amendoim.', grades: [{subject: 'Matemática', score: 8.5, term: '1º Trimestre', type: 'Prova', weight: 2}, {subject: 'Português', score: 9.0, term: '1º Trimestre', type: 'Prova', weight: 2}], attendance: [{date: '2024-07-28', status: 'Presente'}], occurrences: [], documents: [], individualAgenda: [{id: 1, date: '2024-07-29', createdAt: '2024-07-29T10:00:00Z', type: IndividualAgendaItemType.Alimentacao, selections: ['Comeu tudo'], description: 'Almoçou bem!', isSent: true}], communicationLog: [], school_id: MOCK_SCHOOL_ID },
    { id: 2, name: 'Mariana Oliveira', class: 'Turma B', enrollmentDate: '2023-02-01', status: StudentStatus.Active, parentName: 'João Oliveira', parentContact: '(11) 92345-6789', avatarUrl: 'https://picsum.photos/seed/student2/100/100', cpf: '234.567.890-12', address: 'Avenida Brasil, 456', email: 'joao.oliveira@email.com', phone: '(11) 92345-6789', tuition_plan_id: 2, medicalNotes: '', grades: [], attendance: [], occurrences: [], documents: [], individualAgenda: [], communicationLog: [], school_id: MOCK_SCHOOL_ID },
    { id: 3, name: 'Pedro Santos', class: 'Turma A', enrollmentDate: '2022-08-10', status: StudentStatus.Active, parentName: 'Carla Santos', parentContact: '(11) 93456-7890', avatarUrl: 'https://picsum.photos/seed/student3/100/100', cpf: '345.678.901-23', address: 'Praça da Sé, 789', email: 'carla.santos@email.com', phone: '(11) 93456-7890', tuition_plan_id: 1, medicalNotes: '', grades: [], attendance: [], occurrences: [], documents: [], individualAgenda: [], communicationLog: [], school_id: MOCK_SCHOOL_ID },
    { id: 4, name: 'Julia Souza', class: 'Turma C', enrollmentDate: '2023-02-01', status: StudentStatus.Inactive, parentName: 'Marcos Souza', parentContact: '(11) 94567-8901', avatarUrl: 'https://picsum.photos/seed/student4/100/100', cpf: '456.789.012-34', address: 'Rua Augusta, 101', email: 'marcos.souza@email.com', phone: '(11) 94567-8901', tuition_plan_id: 2, medicalNotes: '', grades: [], attendance: [], occurrences: [], documents: [], individualAgenda: [], communicationLog: [], school_id: MOCK_SCHOOL_ID },
];
